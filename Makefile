...
INC_DIRS_CROSS = inc/ ../../EVTGitHub/lpc11cx4-library/lpc_chip_11cxx_lib/inc ../../EVTGitHub/lpc11cx4-library/evt_lib/inc/
...
SRCS_DIRS = ../../EVTGitHub/lpc11cx4-library/lpc_chip_11cxx_lib/src ../../EVTGitHub/lpc11cx4-library/evt_lib/src/ src/
...
C_SRCS_TEST = $(wildcard $(patsubst %, %/*.$(C_EXT), . $(TEST_SRCS_DIRS))) src/can_utils.c
